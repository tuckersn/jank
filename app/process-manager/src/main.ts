...
import { ElectronMessage, InitializationPayload, LogPayload } from "@janktools/shared/src/communication/process-manager-ipc"
import { NodeIPC } from "./node-ipc";
import { ProcessRegistry } from "./processes/process-registry";
import { WebSocketServer } from "./websocket-server";
import { logger } from "./logger";
import { ProcessManagerWS } from "@janktools/shared/dist/communication/process-manager-ws";
